**Mirror Bot** is a _multipurpose_ Telegram Bot written in Python for mirroring files on the Internet to our beloved Google Drive. Based on [python-aria-mirror-bot](https://github.com/lzzy12/python-aria-mirror-bot)
...
- Clone this repo:
```
git clone https://github.com/ItsPriyo/Priyo_Mirror mirrorbot/
cd mirrorbot
```
...
- `DATABASE_URL`: Your Database URL. See [Generate Database](https://github.com/ItsPriyo/Priyo_Mirror/tree/master#generate-database) to generate database (**NOTE**: If you use database you can save your Sudo ID permanently using `/addsudo` command).
...
- `USE_SERVICE_ACCOUNTS`: (Leave empty if unsure) Whether to use Service Accounts or not. For this to work see [Using Service Accounts](https://github.com/ItsPriyo/Priyo_Mirror#generate-service-accounts-what-is-service-account) section below.
...
**NOTE**: If you want to use port other than 80, change it in [docker-compose.yml](https://github.com/ItsPriyo/Priyo_Mirror/blob/master/docker-compose.yml)
...
<p><a href="https://github.com/ItsPriyo/Priyo_Mirror/wiki/Deploying-slam-mirrorbot-on-Heroku-with-Github-Workflows"> <img src="https://img.shields.io/badge/Deploy%20Guide-blueviolet?style=for-the-badge&logo=heroku" width="170""/></a></p>
...
# Youtube-dl authentication using [.netrc](https://github.com/ItsPriyo/Priyo_Mirror/blob/master/.netrc) file
